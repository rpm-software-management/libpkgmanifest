...
class TestManifestParser(base_test_case.BaseTestCase):
    def test_parse_simple_manifest(self):
        ...
        self.assertEqual('fedcba22222222222222222222222222', package2.checksum.digest)
        self.assertEqual('', package2.hdr_checksum.digest)
        ...
        self.assertEqual('3333333333333333333333333333333333333333333333333333333333333333', package3.checksum.digest)
        self.assertEqual('', package3.hdr_checksum.digest)
