...
class TestParser(base_test_case.BaseTestCase):
    def test_parse_simple_file(self):
        ...
        self.assertEqual('', package2.repo_id)
        self.assertEqual('http://some.server.org/folder/nevra2.rpm', package2.url)
        ...
        self.assertEqual('', package2.srpm)
        ...
        self.assertEqual('', package3.srpm)
