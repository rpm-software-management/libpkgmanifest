...
class PrototypeFileConverterTest : public Test {
protected:
    virtual void SetUp() {
    ...
    std::unique_ptr<PrototypeFileConverter> converter;
};

TEST_F(PrototypeFileConverterTest, ConverterConvertsTheNodeToTheExpectedInputFormat) {
