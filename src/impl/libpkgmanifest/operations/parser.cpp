...
std::unique_ptr<IInput> Parser::parse_input([[maybe_unused]] const std::string & path) const {
    throw;
}

std::unique_ptr<IInput> Parser::parse_input_from_prototype([[maybe_unused]] const std::string & path) const {
    throw;
}
